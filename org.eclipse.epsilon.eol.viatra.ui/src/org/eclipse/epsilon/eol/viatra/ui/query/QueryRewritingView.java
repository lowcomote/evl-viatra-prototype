...
public class QueryRewritingView extends ViewPart {
	...
	public void createPartControl(Composite parent) {
		...
		if (getActiveEditorFilePath().split("\\.")[1].equals("etl"))
			doRewriting(getActiveEditorFilePath(), "etl");
	...
	public void doRewriting(String activeFile, String extension) {
		if (extension.equals("evl")) {
			...
			new EvlRewritingHandler().invokeRewriters((IEvlModule) module, staticAnlayser);
